...
cfg_file = "/Users/chinmay/foo/open3d-0.18-build/Open3D/build/Open3D-ML/ml3d/configs/pointpillars_kitti.yml"
...
pipeline = ml3d.pipelines.ObjectDetection(model, dataset=dataset, **cfg.pipeline)
