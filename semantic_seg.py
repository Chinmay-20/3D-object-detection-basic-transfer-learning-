...
cfg_file = "/Users/chinmay/foo/open3d-0.18-build/Open3D/build/Open3D-ML/ml3d/configs/randlanet_semantickitti.yml"
...
pipeline = ml3d.pipelines.SemanticSegmentation(model, dataset=dataset, **cfg.pipeline) # device="gpu"
